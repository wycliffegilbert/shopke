...
const PHONE = '254715545278'; // ← replace with your actual WhatsApp number
const QUICK_MESSAGES = [
  { icon: <ShoppingBag size={15} />, label: 'Product enquiry', message: 'Hi TrendsVault! I have a question about a product.' },
  { icon: <Truck size={15} />, label: 'Track my order', message: 'Hi TrendsVault! I\'d like to track my order.' },
  { icon: <RotateCcw size={15} />, label: 'Return / Refund', message: 'Hi TrendsVault! I need help with a return or refund.' },
  { icon: <HelpCircle size={15} />, label: 'General support', message: 'Hi TrendsVault! I need some help.' },
];
        ...
        {open && (
          <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 w-72 overflow-hidden animate-fade-in">
            ...
            <div className="bg-[#25D366] px-4 py-4">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <p className="text-white font-bold text-sm">TrendsVault Support</p>
            ...
            <div className="p-3 space-y-2">
              ...
              <button
                onClick={() => openChat('Hi TrendsVault!')}

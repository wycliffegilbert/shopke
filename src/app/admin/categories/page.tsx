...
function EmojiPicker({ value, onChange }: { value: string; onChange: (e: string) => void }) {
  ...
  const filtered = search
    ...
    : EMOJI_GROUPS[activeGroup as keyof typeof EMOJI_GROUPS] || [];
    ...
    <div className="border border-gray-200 rounded-xl overflow-hidden">
      ...
      <div className="p-2 border-b border-gray-100">
        <input
          ...
          className="w-full px-3 py-1.5 text-sm border border-gray-200 rounded-lg outline-none focus:border-accent"
        />
      </div>
      ...
      <div className="grid grid-cols-8 gap-0.5 p-2 max-h-40 overflow-y-auto">
        {filtered.map(emoji => (
          <button
            ...
            className={cn(
              'w-8 h-8 flex items-center justify-center text-xl rounded-lg transition-all hover:bg-gray-100',
        ...
        {filtered.length === 0 && (
          <p className="col-span-8 text-center text-xs text-gray-400 py-4">No emoji found</p>
        )}
      </div>
    </div>
  );
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-2">
              <button
                ...
                className={cn(
                  'w-16 h-16 text-4xl rounded-2xl border-2 flex items-center justify-center transition-all',
            ...
            {showPicker && (
              <EmojiPicker value={icon} onChange={e => { setIcon(e); setShowPicker(false); }} />
            )}
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex items-end pb-1">
              <button
                ...
                className={cn(
                  'flex items-center gap-2 px-4 py-3 rounded-xl border-2 w-full transition-all',
...
export default function AdminCategoriesPage() {
  ...
  const totalProducts = (categories || []).reduce((s: number, c: any) => s + (c.product_count || 0), 0);
    ...
    <div className="p-6 max-w-6xl mx-auto">
      ...
      {isLoading ? (
        ...
        <div className="card p-16 text-center">
          ...
          <button onClick={() => setModal('new')} className="btn-primary mt-2">
            ...
            <div
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className={cn(
                    'flex-1 flex items-center justify-center gap-1.5 py-2 text-xs font-medium rounded-xl border transition-colors',
                    cat.is_active
